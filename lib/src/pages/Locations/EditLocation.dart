...
class EditLocationWidget extends StatefulWidget {
  ...
  EditLocationWidget({Key? key, this.parentScaffoldKey, required this.location})
      : super(key: key);
  @override
  _EditLocationWidgetState createState() => _EditLocationWidgetState();
}

class _EditLocationWidgetState extends StateMVC<EditLocationWidget> {
  late LocationController _con;
  late TextEditingController _addressCon;

  late ActLocation location;

  _EditLocationWidgetState() : super(LocationController()) {
  ...
  void initState() {
    ...
    _con.nameController.text = location.name ?? '';
    _con.commentController.text = location.comment ?? '';
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  autovalidateMode: AutovalidateMode.onUserInteraction,
                  decoration: Helper.of(context).textInputDecoration(
                      AppLocalizations.of(context)!.locationPickAddress,
                      AppLocalizations
                          .of(context)
                          !.locationTapToPickAnAddress), // 'Tap to pick an address' // 'Address'
                  onTap: () {
