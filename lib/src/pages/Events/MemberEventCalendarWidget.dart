...
import '../../elements/MyCalendarEventWidget.dart';

class MemberEventCalendarWidget extends StatefulWidget {
  List<MyEvent> events;
  ...
  @override
  _MemberEventCalendarWidget createState() => _MemberEventCalendarWidget();
}

class _MemberEventCalendarWidget extends StateMVC<MemberEventCalendarWidget>
  ...
  _MemberEventCalendarWidget() : super();
  ...
  Widget _buildEventList() {
    return ListView(
      ...
      children: widget.events
          ...
          .toList()
          .map(
            (event) => MyCalendarEventWidget(
              event: event,
              onCancel: () => widget.cancelEvent(event),
              onRegister: () => widget.registerEvent(event),
            ),
          )
          .toList(),
    );
